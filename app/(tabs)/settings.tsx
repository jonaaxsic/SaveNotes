  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: background }]} edges={["top"]}>
      <View style={[styles.container, { backgroundColor: background }]}>
        ...
        <Text style={[styles.sub, { color: Colors[theme].mutedForeground }]}>Configuración de la app</Text>

        <View style={[styles.card, { borderColor, backgroundColor: Colors[theme].card }]}>
          <View style={styles.row}>
            ...
            <Ionicons name="chevron-forward" size={18} color={Colors[theme].mutedForeground} style={styles.chevron} />
          </View>
          <View style={[styles.divider, { backgroundColor: borderColor }]} />
          <View style={styles.row}>
            <Ionicons name="language-outline" size={20} color={textColor} />
            <Text style={[styles.rowText, { color: textColor }]}>Idioma</Text>
            <Text style={[styles.rowValue, { color: Colors[theme].mutedForeground }]}>Español</Text>
          </View>
          <View style={[styles.divider, { backgroundColor: borderColor }]} />
          <View style={styles.row}>
            <Ionicons name="information-circle-outline" size={20} color={textColor} />
            <Text style={[styles.rowText, { color: textColor }]}>Acerca de</Text>
            <Text style={[styles.rowValue, { color: Colors[theme].mutedForeground }]}>SaveNotes 1.0.0</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
